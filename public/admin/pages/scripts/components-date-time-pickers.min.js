    ...
    var t = function() {
        ...
        o = function() {
            jQuery().daterangepicker && ($("#defaultrange").daterangepicker({
                ...
                $("#defaultrange input").val(t.format('YYYY-MM-DD') + " to " + e.format('YYYY-MM-DD'))
                ...
                $("#defaultrange_modal input").val(t.format('YYYY-MM-DD') + " to " + e.format('YYYY-MM-DD'))
                ...
                $("#reportrange span").html(t.format('YYYY-MM-DD') + " to " + e.format('YYYY-MM-DD'))
