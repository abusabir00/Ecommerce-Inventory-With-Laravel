    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>MANAGE ORDER </div>
                <div class="tools"> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                    ...
                    @foreach($orderValue as $value)
                        <tr>
                            ...
                            <td>
                                <span>
                                    <a href="{{ url('/singleOrder/'.$value->id) }}" class="btn btn-icon-only default" >
                                    <i class="fa fa-user"></i>
                                </a>
                                <a href="{{ url('/delOrder/'.$value->id.'/'.$value->shippingId) }}" class="btn btn-icon-only purple" onclick="return confirm('Are you sure to delete this');" >
